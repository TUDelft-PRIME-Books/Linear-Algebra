...
In {numref}`Sec:OrthoBase` we have seen that orthogonal bases are nice to work with. Both for finding coordinates and also for finding orthogonal projections.
